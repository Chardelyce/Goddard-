...
public class SettingsrocketActivity extends AppCompatActivity {
...
/*TextView dates = (TextView)findViewById(R.id.date);
dates.setText(  "EEE, d MMM yyyy, HH:mm");
                DateFormat df = new SimpleDateFormat("EEE, d MMM yyyy, HH:mm");
                String date = df.format(Calendar.getInstance().getTime());*/

                NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(SettingsrocketActivity. this,
